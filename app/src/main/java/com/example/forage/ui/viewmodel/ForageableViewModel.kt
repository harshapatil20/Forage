...
class ForageableViewModel(
    ...
    val forageables: LiveData<List<Forageable>> = forageableDao.getForgeables().asLiveData()

    fun getForageable(id: Long): LiveData<Forageable> {
        return forageableDao.getForgeable(id).asLiveData()
    }
...
class ForageableViewModelFactory(
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        throw IllegalArgumentException("Invalid ViewModel passed.")
    }
